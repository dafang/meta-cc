...
func TestExecuteQueryTimeFilter(t *testing.T) {
	...
	tr1 := querypkg.ParsedTimeRange{Since: &tMinus1h30m}
	...
	tr2 := querypkg.ParsedTimeRange{Until: &tMinus30m}
	...
	tr3 := querypkg.ParsedTimeRange{Since: &tMinus1h30m, Until: &tMinus30m}
