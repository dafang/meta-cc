// Package jq provides pure JSONL/jq processing utilities: filtering, statistics,
// and session grouping. It has no dependency on the parent query package, making
// it independently importable.
package jq
