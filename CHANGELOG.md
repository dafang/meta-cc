...
- query_summaries(stats_only=true) returns diagnostic when no summaries exist
...
- preserve owner and metadata when generating marketplace.json in install-user
...
- Maintenance: bump version to 3.0.4
...
- Maintenance: bump version to 3.0.3
- Maintenance: ignore CHANGELOG.md.bak
...
- Maintenance: bump version to 2.3.5
